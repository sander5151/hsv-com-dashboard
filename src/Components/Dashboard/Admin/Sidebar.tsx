...
import { ArrowLeftOnRectangleIcon, BellAlertIcon, HomeIcon, ListBulletIcon, TicketIcon, UsersIcon } from "@heroicons/react/24/outline";
                    ...
                    <ul className="flex flex-col py-4">
                        <li>
                            <a href="#" className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-orange-600 group">
                                <span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><HomeIcon className="h-6 w-6 text-gray-400" /></span>
                        ...
                        <li>
                            <a href="#" className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-orange-600">
                                <span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><UsersIcon className="h-6 w-6 text-gray-400" /></span>
